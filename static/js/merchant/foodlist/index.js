...
$(".btn-detail").click(function () {
    ...
    $(".checkboxProductCategoryDetail .custom-checkbox").change(function () {
        ...
        $("#dropdownCategoryProductDetail").text(
            selectedOptions.length > 0 ? selectedOptions.join(", ") : "Chọn các danh mục cho sản phẩm của bạn."
        );
...
$(".checkboxCategory .custom-checkbox").change(function () {
    ...
    $("#dropdownCategory").text(
        selectedOptions.length > 0 ? selectedOptions.join(", ") : "Hãy chọn thêm những loại kinh doanh của cửa hàng bạn (nếu muốn)"
    );
